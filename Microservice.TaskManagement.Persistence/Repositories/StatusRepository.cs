...
{
    public class StatusRepository : Repository<StatusEntity, TaskManagementContext>, IStatusRepository
    {
        public StatusRepository(TaskManagementContext context, IMapper mapper) : base(context, mapper)
        {
